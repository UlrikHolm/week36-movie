...
//        Clean up database after test is done or use a persistence unit with drop-and-create to start up clean on every test
    ...
    public void setUp() {
        ...
        try {
            ...
            em.persist(new Movie("Titanic", "James Cameron", 1998));
            em.persist(new Movie("King Kong", "Peter Jackson", 2005));
...
//        Remove any data after each test was run
    ...
    public void testAFacadeMethod() {
        assertEquals(2, facade.getMovieMeCount(), "Expects two rows in the database");
    }
